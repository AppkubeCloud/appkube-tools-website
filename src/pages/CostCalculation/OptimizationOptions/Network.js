...
class Network extends Component {
  ...
  isSticky = (e) => {
    const tabs = document.querySelector(".tabs-network-charts");
        ...
        <div className="tabs-network-charts">
          <div className="compute-contain network">
            <div className="compute-cost">
              <span>{dataChange ? 1.5 : 1.6} TB/day</span>
              <div
                className="progress"
            ...
            <div className="compute-cost">
              <span>${dataChange ? 0.45 : 0.4}/GB transferred</span>
              <div
                className="progress"
            ...
            <div className="compute-cost">
              <span>${dataChange ? "50,000" : "50,000"}</span>
              <div
                className="progress"
          ...
          <div className="compute-total-cost d-flex justify-content-between">
            <span>Total cost: $ {dataChange ? "985,000" : "785,000"}/year</span>
            <button
              className="btn"
